...
/* Created on:     16/12/2021 10:33:44                          */
/*==============================================================*/
...
if exists (select 1
            from  sysobjects
           where  id = object_id('CRMTB064_CLIENTE_CSS')
            and   type = 'U')
   drop table CRMTB064_CLIENTE_CSS
go

if exists (select 1
            from  sysobjects
           where  id = object_id('CRMTB065_TOMADOR_REQ')
            and   type = 'U')
   drop table CRMTB065_TOMADOR_REQ
go

if exists (select 1
            from  sysobjects
           where  id = object_id('CRMTB066_ENTR_CADASTRO_POSIT')
            and   type = 'U')
   drop table CRMTB066_ENTR_CADASTRO_POSIT
go

if exists (select 1
            from  sysobjects
           where  id = object_id('CRMTB067_ENTR_CADAS_RESTR')
            and   type = 'U')
   drop table CRMTB067_ENTR_CADAS_RESTR
go
...
if exists (select 1
            from  sysobjects
           where  id = object_id('CRMTB900_PARAMETRO_MAMO')
            and   type = 'U')
   drop table CRMTB900_PARAMETRO_MAMO
go

if exists (select 1
            from  sysobjects
           where  id = object_id('CRMTB901_PONTUACAO_CLIENTE')
            and   type = 'U')
   drop table CRMTB901_PONTUACAO_CLIENTE
go

if exists (select 1
            from  sysobjects
           where  id = object_id('CRMTB902_PONTUACAO_CLIENTE_PRD')
            and   type = 'U')
   drop table CRMTB902_PONTUACAO_CLIENTE_PRD
go
...
create table DM.CRMTB014_CONTRATO_CREDITO (
   ...
   NU_CONTA_DEBITO      DECIMAL(20)          null,
   ...
   VR_SEGURO_GARANTIA   DECIMAL(17,2)
         null,
   NU_CONTA_CREDITO_SIDEC DECIMAL(20)          null,
...
create table DM.CRMTB028_CLIENTE_RENDA (
   NU_CLIENTE           NUMERIC(13)          not null,
   DT_APURACAO_RENDA    DATE                 not null,
   NU_CPF_CNPJ          NUMERIC(14)          null,
   NU_TIPO_PESSOA       SMALLINT             null,
   IC_SEM_RENDA         CHAR(1)              null,
   ...
   DH_INGESTAO_SILDC    DATETIME             null,
   DH_INGESTAO_BASE_INTEGRADORA DATETIME             null,
   constraint PK_CRMTB028 primary key (NU_CLIENTE, DT_APURACAO_RENDA)
)
go
...
create table DM.CRMTB029_CLIENTE_FATURAMENTO (
   NU_CLIENTE           NUMERIC(13)          not null,
   DT_APURACAO_FATURAMENTO DATE                 not null,
   NU_CPF_CNPJ          NUMERIC(14)          null,
   NU_TIPO_PESSOA       SMALLINT             null,
   IC_PERIODICIDADE_FATURAMENTO CHAR(1)              null,
   IC_SEM_FATURAMENTO   CHAR(1)              null,
   AA_REFERENCIA_FATURAMENTO NUMERIC(5)           null,
   ...
   AA_FATURAMENTO       NUMERIC(5)           null,
   CO_SISTEMA_ORIGEM    VARCHAR(100)         null,
   DH_POSICAO_LEGADO    DATETIME             null,
   DH_INGESTAO_SILDC    DATETIME             null,
   DH_INGESTAO_BASE_INTEGRADORA DATETIME             null,
   constraint PK_CRMTB029 primary key (NU_CLIENTE, DT_APURACAO_FATURAMENTO)
)
go
...
create table DM.CRMTB031_CADASTRO_ENDERECO (
   ...
   DT_APURACAO_ENDERECO DATE                 not null,
   NU_CPF_CNPJ          NUMERIC(14)          null,
   NU_TIPO_PESSOA       SMALLINT             null,
   NO_CLIENTE           VARCHAR(70)          null,
...
create table DM.CRMTB034_CLIENTE_CONTRATO (
   NU_CLIENTE           NUMERIC(13)          not null,
   NU_SEQUENCIAL_CONTRATO SMALLINT             not null,
   NU_CPF_CNPJ          NUMERIC(14)          null,
   NU_TIPO_PESSOA       SMALLINT             null,
   CO_CONTRATO          VARCHAR(26)          null,
   NU_PRODUTO           SMALLINT             null,
   ...
   DH_INGESTAO_SILDC    DATETIME             null,
   DH_INGESTAO_BASE_INTEGRADORA DATETIME             null,
   constraint PK_CRMTB034 primary key (NU_CLIENTE, NU_SEQUENCIAL_CONTRATO)
)
go
...
/*==============================================================*/
create table CRMTB064_CLIENTE_CSS (
   NU_CLIENTE           NUMERIC(13)          not null,
   NU_CPF_CNPJ          NUMERIC(14)          not null,
   NU_TIPO_PESSOA       SMALLINT             null,
...
/*==============================================================*/
create table CRMTB065_TOMADOR_REQ (
...
/*==============================================================*/
create table CRMTB066_ENTR_CADASTRO_POSIT (
   NU_CLIENTE           NUMERIC(13)          null,
   NU_CPF___CNPJ        NUMERIC(14)          null,
   NU_TIPO_PESSOA       SMALLINT             null,
...
/*==============================================================*/
create table CRMTB067_ENTR_CADAS_RESTR (
   NU_CLIENTE           NUMERIC(13)          null,
   NU_CPF_CNPJ          NUMERIC(14)          null,
...
/*
	-- SIM DUAS FORMAS DE COMENTÁRIOS, JUSTAMENTE PARA NÃO EXECUTAREM!!!
